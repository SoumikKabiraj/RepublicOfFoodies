...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded myimg" src="images/rf.png"  alt=""> </a>
                    <style media="screen">
                      .myimg{
                        height: 3vw  ;
                        margin: 0vw;
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/dish.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1 class="sa">Delivery & Take-Out </h1>
                    <style media="screen">
                      .sa{
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/rf.png" style="height: 7vw" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
